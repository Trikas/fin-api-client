...
> \Swagger\Client\Model\IdentifierList deleteAllTransactions($max_deletion_date, $min_import_date, $account_ids, $safe_mode, $remember_deletion)
...
try {
    $result = $apiInstance->deleteAllTransactions($max_deletion_date, $min_import_date, $account_ids, $safe_mode, $remember_deletion);
    print_r($result);
} catch (Exception $e) {
