 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserCreateParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserCreateParams';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_auto_update_enabled'] = isset($data['is_auto_update_enabled']) ? $data['is_auto_update_enabled'] : false;
    }
     ...
     * Sets id
     *
     * @param string $id User's identifier. Max length is 36 symbols. Only the following symbols are allowed: 0-9, A-Z, a-z, -, _, ., +, @. If not specified, then a unique random value will be generated.
     *
     * @return $this
     */
     ...
     * Sets password
     *
     * @param string $password User's password. Minimum length is 6, and maximum length is 128. If not specified, then a unique random value will be generated.
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string $email User's email address. Maximum length is 320.
     *
     * @return $this
     */
     ...
     * Sets phone
     *
     * @param string $phone User's phone number. Maximum length is 50.
     *
     * @return $this
     */
