...
class Payment implements ModelInterface, ArrayAccess
{
     ...
     * Sets account_id
     *
     * @param int $account_id Identifier of the account to which this payment relates. This field is only set if it was specified upon creation of the payment.
     *
     * @return $this
     */
     ...
     * Sets iban
     *
     * @param string $iban IBAN of the account to which this payment relates. This field is only set if it was specified upon creation of the payment.
     *
     * @return $this
     */
     ...
     * Sets execution_date
     *
     * @param string $execution_date Time of when this payment was executed by finAPI, in the format 'YYYY-MM-DD HH:MM:SS.SSS' (german time)<br/>Note: this is not necessarily identical to the date when the bank will book the payment, e.g. if a future date was given in the 'executionDate' field of the payment.
     *
     * @return $this
     */
