...
class ClientConfigurationParams implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $support_subject_default Default value for the subject element of support emails. Maximum length is 100. Pass an empty string ('') if you want to clear the current subject default value.
     *
     * @return $this
     */
     ...
     * Sets support_email
     *
     * @param string $support_email Email address to sent support requests to from the web form. Maximum length is 320. Pass an empty string ('') if you want to clear the current email address.
     *
     * @return $this
     */
