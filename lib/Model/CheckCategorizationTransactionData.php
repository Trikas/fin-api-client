 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CheckCategorizationTransactionData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CheckCategorizationTransactionData';
     ...
     * Sets mc_code
     *
     * @param string $mc_code Merchant category code (for credit card transactions only). May only contain up to 4 digits. Default value: null.
     *
     * @return $this
     */
     ...
     * Sets type_code_zka
     *
     * @param string $type_code_zka ZKA business transaction code which relates to the transaction's type (Number from 0 through 999). Default value: null.
     *
     * @return $this
     */
