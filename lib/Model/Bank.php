...
class Bank implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'bank_group' => '\Swagger\Client\Model\BankGroup',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['bank_group'] = isset($data['bank_group']) ? $data['bank_group'] : null;
     ...
     * Sets is_supported
     *
     * @param bool $is_supported THIS FIELD IS DEPRECATED AND WILL BE REMOVED. Please refer to field 'interfaces' instead.<br/><br/>Whether this bank is supported by finAPI, i.e. whether you can import/update a bank connection of this bank.
     *
     * @return $this
     */
     ...
     *
     * @param bool $pins_are_volatile THIS FIELD IS DEPRECATED AND WILL BE REMOVED. Refer to the 'isVolatile' field of the 'loginCredentials' in 'interfaces' instead.<br/><br/>Whether the PINs that are used for authentication with the bank are volatile. If the PINs are volatile, it means that the value for the field, which is provided by the user, is valid only for a single authentication and then gets invalidated on bank-side. If pinsAreVolatile is true, it is not possible to store the PIN in finAPI, as a stored PIN will never work for future authentications.<br><br>NOTE: This field is deprecated and will be removed at some point.
     *
     * @return $this
     */
     ...
     * Gets bank_group
     *
     * @return \Swagger\Client\Model\BankGroup
     */
     ...
     * Sets bank_group
     *
     * @param \Swagger\Client\Model\BankGroup $bank_group Bank group
     *
     * @return $this
     */
     ...
     *
     * @param string $last_successful_communication THIS FIELD IS DEPRECATED AND WILL BE REMOVED. Refer to the 'lastSuccessfulCommunication' in the 'interfaces' instead. <br/><br/>Time of the last successful communication with this bank during a bank connection import or update (across the entire finAPI system). The value is returned in the format 'YYYY-MM-DD HH:MM:SS.SSS' (german time).
     *
     * @return $this
     */
