...
class ErrorDetails implements ModelInterface, ArrayAccess
{
    ...
    const CODE_LOGIN_FIELDS_MISMATCH = 'LOGIN_FIELDS_MISMATCH';
    ...
    const CODE_NO_PSU_METADATA = 'NO_PSU_METADATA';
    ...
    const CODE_UNSUPPORTED_FEATURE = 'UNSUPPORTED_FEATURE';
    ...
    public function getCodeAllowableValues()
    {
        return [
            ...
            self::CODE_LOCKED,
            self::CODE_LOGIN_FIELDS_MISMATCH,
            self::CODE_METHOD_NOT_ALLOWED,
            self::CODE_MISSING_CREDENTIALS,
     ...
     * Sets type
     *
     * @param string $type Error type. BUSINESS errors depict error messages in the language of the bank (or the preferred language) for the user, e.g. from a bank server. TECHNICAL errors are meant to be read by developers and depict internal errors.
     *
     * @return $this
     */
