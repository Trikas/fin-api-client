...
class TransactionsApi
{
     ...
     */
    public function deleteAllTransactions($max_deletion_date = null, $min_import_date = null, $account_ids = null, $safe_mode = 'true', $remember_deletion = 'false')
    {
        list($response) = $this->deleteAllTransactionsWithHttpInfo($max_deletion_date, $min_import_date, $account_ids, $safe_mode, $remember_deletion);
        return $response;
    }
     ...
     */
    public function deleteAllTransactionsWithHttpInfo($max_deletion_date = null, $min_import_date = null, $account_ids = null, $safe_mode = 'true', $remember_deletion = 'false')
    {
        $returnType = '\Swagger\Client\Model\IdentifierList';
        $request = $this->deleteAllTransactionsRequest($max_deletion_date, $min_import_date, $account_ids, $safe_mode, $remember_deletion);
     ...
     */
    public function deleteAllTransactionsAsync($max_deletion_date = null, $min_import_date = null, $account_ids = null, $safe_mode = 'true', $remember_deletion = 'false')
    {
        return $this->deleteAllTransactionsAsyncWithHttpInfo($max_deletion_date, $min_import_date, $account_ids, $safe_mode, $remember_deletion)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAllTransactionsAsyncWithHttpInfo($max_deletion_date = null, $min_import_date = null, $account_ids = null, $safe_mode = 'true', $remember_deletion = 'false')
    {
        $returnType = '\Swagger\Client\Model\IdentifierList';
        $request = $this->deleteAllTransactionsRequest($max_deletion_date, $min_import_date, $account_ids, $safe_mode, $remember_deletion);
     ...
     */
    protected function deleteAllTransactionsRequest($max_deletion_date = null, $min_import_date = null, $account_ids = null, $safe_mode = 'true', $remember_deletion = 'false')
    {
        if ($max_deletion_date !== null && $max_deletion_date > 10) {
            throw new \InvalidArgumentException('invalid value for "$max_deletion_date" when calling TransactionsApi.deleteAllTransactions, must be smaller than or equal to 10.');
        }
        if ($max_deletion_date !== null && $max_deletion_date < 10) {
            throw new \InvalidArgumentException('invalid value for "$max_deletion_date" when calling TransactionsApi.deleteAllTransactions, must be bigger than or equal to 10.');
        }

        if ($min_import_date !== null && $min_import_date > 10) {
            throw new \InvalidArgumentException('invalid value for "$min_import_date" when calling TransactionsApi.deleteAllTransactions, must be smaller than or equal to 10.');
        }
        if ($min_import_date !== null && $min_import_date < 10) {
            throw new \InvalidArgumentException('invalid value for "$min_import_date" when calling TransactionsApi.deleteAllTransactions, must be bigger than or equal to 10.');
        }
